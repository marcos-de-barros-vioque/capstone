...
export default function Entertainment({spendingInput}) {
  const routing = useRouter();

  return (
    <>
      <StyledHeader>
        <StyledTitle>Your Spendings for Entertainment</StyledTitle>
      </StyledHeader>
      <StyledBody>
        <StyledLog>
          {spendingInput
            .filter(spendingInput => spendingInput.category === "Entertainment")
