...
export default function Restaurants({spendingInput}) {
  const routing = useRouter();

  return (
    <>
      <StyledHeader>
        <StyledTitle>Your Spendings for Restaurants</StyledTitle>
      </StyledHeader>
      <StyledBody>
        <StyledLog>
          {spendingInput
            .filter(spendingInput => spendingInput.category === "Restaurants")
